...
class PoliticiansControllerTest < ActionController::TestCase
  ...
  test "should create politician" do
    assert_difference('Politician.count') do
      post :create, politician: { location: @politician.location, name: @politician.name, rating: @politician.rating }
    end
  ...
  test "should update politician" do
    patch :update, id: @politician, politician: { location: @politician.location, name: @politician.name, rating: @politician.rating }
    assert_redirected_to politician_path(assigns(:politician))
  end
